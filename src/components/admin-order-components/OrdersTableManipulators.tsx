...
interface OrdersTableManipulatorsProps {
    onSortChange: (sortOption: string | null, direction: "asc" | "desc") => void;
    onSearchChange: (query: string) => void;
}

function OrdersTableManipulators({ onSortChange, onSearchChange }:OrdersTableManipulatorsProps) {
...
export default OrdersTableManipulators;